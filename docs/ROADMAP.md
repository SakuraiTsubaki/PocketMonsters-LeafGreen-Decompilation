...
- [ ] Exhaustively survey publicly accessible source families relevant to Pokémon LeafGreen, beginning from the original Japanese release and tracing every confirmed regional, language, revision, distribution, peripheral, and linked-system variant.
