...
This document is the authoritative coverage ledger for public-source research used by the Pocket Monsters LeafGreen decompilation project.
...
| Official event/distribution preservation | AuroraTicket, MysticTicket and all LeafGreen-linked distributions | In progress |
...
| GameCube linkage | Colosseum, XD, Box and other GBA–GC interactions relevant to LeafGreen | Not yet exhaustive |
...
| PRES-GEKKIO-BPGJ | https://gbhwdb.gekkio.fi/cartridges/AGB-BPGJ-0/ | Preservation / physical | Japanese LeafGreen cartridge identity, board/components and revision evidence | Observed |
