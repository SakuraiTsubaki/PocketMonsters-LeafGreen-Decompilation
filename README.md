# Pocket Monsters LeafGreen — Decompilation
...
Decompilation and source-reconstruction project for **Pokémon LeafGreen**.
...
- LeafGreen-specific language/revision differences remain explicit rather than being flattened into FireRed.
