# Milestones: Pocket Monsters LeafGreen

This roadmap governs research, tooling, analysis, reconstruction, and preservation for `SakuraiTsubaki/PocketMonsters-LeafGreen-Decompilation`.
...
| Field | Current value |
| --- | --- |
| Target | Pocket Monsters LeafGreen |
...
Compare shared Generation III engine and resource structures with FireRed while keeping target identity and layout evidence separate.
